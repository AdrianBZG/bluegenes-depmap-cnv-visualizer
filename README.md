#  Bluegenes DepMap Copy Number Variation

Bluegenes DepMap Copy Number Variation is a tool made for [BlueGenes](http://bluegenes.apps.intermine.org) following BlueGenes Tool API.
...
1. Clone the repo
2. `cd bluegenes-depmap-cnv` and then `npm install` to install dependencies.
